...
public class ControladorInimigo : MonoBehaviour
{
    ...
    [Header("Combate")]
    [Tooltip("Arraste o PREFAB DE ARENA deste monstro aqui")]
    public GameObject prefabDaArena;
    ...
    void IniciarCombate()
    {
        ...
        if(iniciador != null)
        {
            iniciador.DispararBatalha(jogador.gameObject, idUnico, listaPrefab, ListaNivel);
        }
    }
